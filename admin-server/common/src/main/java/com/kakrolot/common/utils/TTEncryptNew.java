...
public class TTEncryptNew {

    private Integer CF = 0;

    public TTEncryptNew(long[] content, String model){
    ...
    public static byte[] ttEncryptNew(byte[] bytes){
        ...
        long[] encrypt = new TTEncryptNew( content , null ).encrypt();
        return changeLongArrayTobytes(encrypt);
    }

    private static long[] changeToLongArray(byte[] bytes){
