...
# 远程服务器信息
remote_server="root@$eavesdropper_client_manager_remote_server"
remote_password="$eavesdropper_client_manager_password"
remote_path="/data/program/application/eavesdropper/client/manager"
...
# 上传文件，避免在调试输出中显示密码
echo "开始上传文件..."
sshpass -p "$remote_password" scp $SSH_OPTS manager.tar.gz "$remote_server:$remote_path"
upload_status=$?
