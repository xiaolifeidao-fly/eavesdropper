var tdist = {
    ...
    350625: ["\u957f\u6cf0\u533a", "350600", "chang tai qu", ""],
    ...
    410728: ["\u957f\u57a3\u5e02", "410700", "chang yuan shi", ""],
    ...
    530422: ["\u6f84\u6c5f\u5e02", "530400", "cheng jiang shi", ""],
    ...
    230725: ["\u5927\u7b90\u5c71\u53bf", "230700", "da qing shan xian", ""],
    ...
    340222: ["\u7e41\u660c\u533a", "340200", "fan chang qu", ""],
    ...
    230724: ["\u4e30\u6797\u53bf", "230700", "feng lin xian", ""],
    ...
    610322: ["\u51e4\u7fd4\u533a", "610300", "feng xiang qu", ""],
    ...
    371203: ["\u94a2\u57ce\u533a", "370100", "gang cheng qu", ""],
    ...
    220381: ["\u516c\u4e3b\u5cad\u5e02", "220100", "gong zhu ling shi", ""],
    ...
    341822: ["\u5e7f\u5fb7\u5e02", "341800", "guang de shi", ""],
    ...
    450127: ["\u6a2a\u5dde\u5e02", "450100", "heng zhou shi", ""],
    ...
    360125: ["\u7ea2\u8c37\u6ee9\u533a", "360100", "hong gu tan qu", ""],
    ...
    411626: ["\u6dee\u9633\u533a", "411600", "huai yang qu", ""],
    ...
    630122: ["\u6e5f\u4e2d\u533a", "630100", "huang zhong qu", ""],
    ...
    620824: ["\u534e\u4ead\u5e02", "620800", "hua ting shi", ""],
    ...
    659010: ["\u80e1\u6768\u6cb3\u5e02", "650000", "hu yang he shi", ""],
    ...
    659008: ["\u53ef\u514b\u8fbe\u62c9\u5e02", "650000", "ke ke da la shi", ""],
    ...
    330399: ["\u9f99\u6e2f\u5e02", "330300", "long gang shi", ""],
    350681: ["\u9f99\u6d77\u533a", "350600", "long hai qu", ""],
    ...
    360727: ["\u9f99\u5357\u5e02", "360700", "long nan shi", ""],
    ...
    130223: ["\u6ee6\u5dde\u5e02", "130200", "luan zhou shi", ""],
    130203: ["\u8def\u5317\u533a", "130200", "lu bei qu", ""],
    140481: ["\u6f5e\u57ce\u533a", "140400", "lu cheng qu", ""],
    ...
    230703: ["\u5357\u5c94\u53bf", "230700", "nan cha xian", ""],
    ...
    231121: ["\u5ae9\u6c5f\u5e02", "231100", "nen jiang shi", ""],
    ...
    451023: ["\u5e73\u679c\u5e02", "451000", "ping guo shi", ""],
    ...
    330113: ["\u94b1\u5858\u533a", "330100", "qian tang qu", ""],
    ...
    140421: ["\u4e0a\u515a\u533a", "140400", "shang dang qu", ""],
    ...
    430521: ["\u90b5\u4e1c\u5e02", "430500", "shao dong shi", ""],
    ...
    520221: ["\u6c34\u57ce\u533a", "520200", "shui cheng qu", ""],
    530630: ["\u6c34\u5bcc\u5e02", "530600", "shui fu shi", ""],
    ...
    230723: ["\u6c64\u65fa\u53bf", "230700", "tang wang xian", ""],
    ...
    451021: ["\u7530\u9633\u533a", "451000", "tian yang qu", ""],
    ...
    632321: ["\u540c\u4ec1\u5e02", "632300", "tong ren shi", ""],
    ...
    130502: ["\u8944\u90fd\u533a", "130500", "xiang dou qu", ""],
    ...
    522322: ["\u5174\u4ec1\u5e02", "522300", "xing ren shi", ""],
    ...
    659011: ["\u65b0\u661f\u5e02", "650000", "xin xing shi", ""],
    ...
    610928: ["\u65ec\u9633\u5e02", "610900", "xun yang shi", ""],
    ...
    610623: ["\u5b50\u957f\u5e02", "610600", "zi chang shi", ""],
    ...
    371626: ["\u90b9\u5e73\u5e02", "371600", "zou ping shi", ""],
...
function getParentCode(code){
    const result = []
    for (const key in tdist) {
        const value = tdist[key];
        const parentCode = value[1];
        if(parentCode == code){
            result.push({
                "code" : key,
                "name" : value[0],
...
var provinceNames = ["特别行政区", "维吾尔自治区", "壮族自治区", "回族自治区", "自治区", "省"];

function getProviceAlias(name){
    for (const provinceName of provinceNames) {
        if(name.includes(provinceName)){
            return name.replace(provinceName, "");
        }
    }
    return name;
}

var cityNames = ["哈萨克自治州","南苗族侗族自治州","布依族苗族自治州","南布依族苗族自治州","藏族羌族自治州",
    "南苗族侗族自治州","南布依族苗族自治州","壮族苗族自治州","布依族苗族自治州","土家族苗族自治州","蒙古族藏族自治州", 
    "傈僳族自治州", "族景颇族自治州","白族自治州","苗族自治州",
    "哈尼族彝族自治州","彝族自治州",
    "柯尔克孜自治州","傣族自治州",
    "的岛礁及其海域","黎族苗族自治县","黎族自治县","架林区","朝鲜族自治州",
    "蒙古自治州","藏族自治州","维吾尔自治州","壮族自治州","回族自治州","自治州","省","市","县","地区"];

function getCityAlias(name){
    for (const cityName of cityNames) {
        if(name.includes(cityName)){
            return name.replace(cityName, "");
        }
    }
    return name;
}
(async () => {
    const provinceList = getParentCode("1");
    const axios = require('axios');
    for(const province of provinceList){
        const cityList = getParentCode(province.code);
        console.log("province : ", province.name, " code : ", province.code, " alias : ", getProviceAlias(province.name))
        for(const city of cityList){
            keywords = getProviceAlias(province.name) + getCityAlias(city.name)
            console.log("name : ", city.name, " code : ", city.code, " parent : ", city.parentCode, " alias : ", keywords)
            const response = await axios.post(`http://localhost:8081/api/address/save`,{
                countryCode: "1",
