  ...
  methods: {
    ...
    getAllData() {
      ...
      this.timer = setTimeout(() => { // 设置延迟执行
        ...
        if (actualSpeepData > 0 && this.lastActualDone > 0 && this.remainTask > 0) {
          ...
          this.lineChartSpeedData.leftTime = parseInt(this.remainTotalTask / (60 * this.lineChartSpeedData.actualSpeed))
        }
        var personSpeed = this.userTask - this.lastUserTask
        if (personSpeed > 0 && this.userTask > 0 && this.lastUserTask > 0) {
