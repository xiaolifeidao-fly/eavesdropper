<template>
  <div class="tab-container" style="margin:1px;">
    ...
    <el-row :gutter="40" class="panel-group">
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="showTaskSummary">
          ...
          <div class="card-panel-description">
            ...
            <vue-count-up :start-val="lastTotalNum" :end-val="totalNum" :duration="1.5" class="card-panel-num" />
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="showUserTaskSummary">
          ...
          <div class="card-panel-description">
            ...
            <vue-count-up :start-val="lastUserTask" :end-val="userTask" :duration="1.5" class="card-panel-num" />
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div class="card-panel-description">
            ...
            <vue-count-up :start-val="lastActualDone" :end-val="actualDone" :duration="3.6" class="card-panel-num" />
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      ...
      <el-dialog title="历史任务数" width="30%" v-model="taskTableVisible">
      ...
      <el-dialog title="历史人工总量" width="30%" v-model="userTaskTableVisible">
      ...
      <el-dialog title="历史消费" width="50%" v-model="consumedTableVisible">
