...
const actions = {
  ...
  // dynamically modify permissions - Commented out as its logic might conflict with permission.js
  /*
  changeRoles({ commit, dispatch }, role) {
    return new Promise(async resolve => {
      ...
      // router.addRoutes(accessRoutes) // Needs update to addRoute loop
