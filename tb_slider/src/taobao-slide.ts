...
async function loginTaobao() {
  // 定义用户数据目录
  const userDataDir = path.join(__dirname, '../chrome-data-' + Math.floor(Math.random() * 1000));
  ...
  try {
    ...
    const validateUrl = 'file:///Users/chai/code/eavesdropper/client/resource/validate_image.html?iframeUrl=';
